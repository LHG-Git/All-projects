...
|초기 고객|이유|
|:------:|------|
|뚜벅이(차량을 보유하지 않은 10~20대 학생들)|차를 소유하고 있지 않아 주로 보행로를 이용하는 고객을 대상으로 서비스를 제공|
|가게 사장(음식점 사장, 공방 사장, 술집 사장 등)|장사가 잘 되는 가게 사장님들은 사람이 많은 것을 고객들에게 부각시켜 시너지 효과를 내고, 장사가 잘 되지 않는 가게 사장님들은 사람이 많은 곳을 찾아다니며 홍보를 할 수 있는 기회를 얻을 수 있게 할 수 있음|
