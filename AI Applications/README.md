...
# 🔎 'WalkFREE' Solution 및 기능
|기능|
|------|
|1) 지도를 통해 보행로 구간별 유동인구 밀집 구간 식별 기능|
|2) 가게 앞 유동인구 혼잡여부 표시 기능|
|3) 실시간 유동인구 수에 따른 한적한 핫플레이스 추천 기능|
|4) 안전 우려 지역 표시 및 보행로 안전사고 예방 기능|
|5) 실시간 발생 안전사고 안내 기능|
|6) 소화기, 자동재세동기 등의 응급 의료 물품 배치 장소 표시 기능|
<br> 
