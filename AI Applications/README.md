...
|기술|설명|
|:------:|------|
|CNN|영상 인식에 많이 사용되는 신경망으로 이미치 처리에 특히 적합한 신경망, 행렬 연산량을 줄이기 위해 곱하고 더하는 행렬 연산으로 데이터를 줄이고 인접 행렬값 중 큰 값을 선택하는 기법 등을 활용한 성능 개선이 특징|
|시각 지능|사람이 사물을 인지하고 시공간적으로 상황을 파악할 수 있는 능력을 의미하며 직관적으로 사물을 인식하는 능력과 심층적 사고에 의한 인지 능력으로 나뉨|
