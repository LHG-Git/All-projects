...
|데이터셋|출처|
|------|:------:|
|전산업생산지수(원지수)|KOSIS 국가통계포털|
|한국가스공사_시간별 공급량|공공데이터포털|
|한국가스공사_도시가스 산업용 월별 상대가격지수|공공데이터포털|
|한국가스공사_도시가스 민수용 월별 상대가격지수|공공데이터포털|
|한국가스공사_도시가스 산업용 월별 가스수요산업지수|공공데이터포털|
|기온데이터|기상청|
|겨울여부, 휴일여부, 특정시간|데이터 병합|
|미세먼지 데이터|공공데이터포털|
|수입물량지수 데이터|한국은행 경제통계시스템|
|수입금액지수 데이터|한국은행 경제통계시스템|
|수입물가지수(원화) 데이터|한국은행 경제통계시스템|
|에너지 소비량 데이터|한국은행 경제통계시스템|
|전력량 데이터|KOSIS 국가통계포털|
<br>
