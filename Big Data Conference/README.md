...
## 🔎 데이터 수집
### 1) 서울시 빅데이터캠퍼스 데이터 활용
* 서울시 지하철 시간대별 승객 수, 서울시 지하철 30분 단위 이용 통계, 서울시 버스정류장 공간데이터, 우수중소기업 공간데이터, 서울시 주요시설과 집객시설 공간데이터, 서울시 대학교 공간데이터를 수집하였습니다.<br>

### 2) 공공 데이터 포털 및 서울 열린 데이터 광장 데이터 활용
* 서울시 지하철호선별, 역별 승하차 인원 정보, 서울시 주요 공원 현황 데이터를 수집하였습니다.<br>

### 3) 기상청 데이터 활용
* 서울시의 지상관측(날씨, 온도, 강수량) 데이터를 수집하였습니다.<br>

### 4) 데이터 크롤링 및 검색
* 서울시 대학교 인원 정보, 서울시 중,고등학교 인원 정보 데이터를 크롤링하였고, 각 호선별 지하철의 량 수를 검색을 통해 수집하였습니다.<br><br>
