...
## 📄 LightGBM
* LightGBM 모델을 사용하여 승하차수를 예측하였고, 평균 절대 오차값인 MAE값을 통해 모델의 성능을 검증하였습니다.
* 1차적으로 파라미터 조정 및 k-fold 교차검증을 이용하지 않고, LightGBM 모델의 default값 그대로 초기 예측을 진행한 결과 <strong>상업그룹의 경우 MAE값이 2600명, 업무주거그룹의 경우 MAE값이 2100명</strong> 정도가 나오는 것을 확인할 수 있었습니다.
